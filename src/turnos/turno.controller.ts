    ...
    try{
        switch(req.body.action){
            case 'consultorios':
                ...
                if (!consultorios) return res.status(404).json({ error: 'No se encontraron consultorios' });
            ...
            case 'especialidades':
                ...
                if (!especialidades) return res.status(404).json({ error: 'No se encontraron especialidades' });
            ...
            case 'kinesiologos':
                ...
                if (!kinesiologos) return res.status(404).json({ error: 'No se encontraron kinesiólogos' });
