...
const pacientes = [
    new Paciente('Facundo', 'Morresi', '45864009', '24/11/2003', 'OSDE', 'facumorresi@yahoo.com.ar', 'facumorresi', 'activo', 'a02b91bc-3769-4221-beb1-d7a3aeba7dad'),
];
function sanitizeCharacterInput(req, _res, next) {
...
app.post('/api/pacientes', sanitizeCharacterInput, (req, res) => {
    const paciente = new Paciente(req.body.sanitizedInput.nombre, req.body.sanitizedInput.apellido, req.body.sanitizedInput.dni, req.body.sanitizedInput.fechaNacimiento, req.body.sanitizedInput.obraSocial, req.body.sanitizedInput.telefono, req.body.sanitizedInput.email, req.body.sanitizedInput.password, req.body.sanitizedInput.estado);
